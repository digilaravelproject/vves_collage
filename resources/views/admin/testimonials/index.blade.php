...
@section('content')
    <div class="p-4 sm:p-6 space-y-6"
        ...
        <div class="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            ...
            <a href="{{ route('admin.testimonials.create') }}" class="flex items-center px-4 py-2 text-sm font-medium text-white bg-(--primary-color) rounded-lg shadow-sm
            ...
            <div x-show="showConfirmModal" x-transition:enter="ease-out duration-300"
                ...
                <div class="mt-6 sm:mt-5 sm:flex sm:flex-row-reverse sm:gap-3">
                    <button @click="formToSubmit.submit(); showConfirmModal = false;" type="button" class="inline-flex justify-center w-full px-4 py-2 text-sm font-semibold text-white transition
                                   bg-(--primary-color) rounded-lg shadow-sm hover:bg-(--primary-hover) focus:outline-none
                                   focus:ring-2 focus:ring-(--primary-color) focus:ring-offset-2 sm:w-auto">
                        Confirm Delete
                    </button>
