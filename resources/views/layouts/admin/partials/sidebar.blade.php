    ...
    <div class="flex items-center justify-between shrink-0 px-6 py-5 border-b border-gray-100">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 group">
            ...
            <div class="overflow-hidden">
                ...
                <p class="text-[10px] font-bold text-(--primary-color) uppercase tracking-widest opacity-70">Admin
                    Control</p>
            </div>
        </a>
        <button class="p-2 rounded-xl lg:hidden hover:bg-gray-100 text-gray-400 hover:text-gray-900 transition-all"
            ...
            <div>
                ...
                <div class="space-y-1">
                    ...
                    {{ request()->routeIs('admin.dashboard')
                        ...
                        <i
                            class="text-lg bi bi-grid-1x2-fill {{ request()->routeIs('admin.dashboard') ? 'text-white' : 'text-gray-400 group-hover:text-(--primary-color)' }}"></i>
                    ...
                    @can('workflow.view')
                        ...
                        {{ request()->routeIs('admin.workflow.index')
                            ...
                            : 'text-gray-600 hover:bg-(--primary-color)/5 hover:text-(--primary-color)' }}">
                                <div class="flex items-center gap-3">
                                    <i
                                        class="text-lg bi bi-shield-check {{ request()->routeIs('admin.workflow.index') ? 'text-white' : 'text-gray-400 group-hover:text-(--primary-color)' }}"></i>
                                    <span>Pending Approvals</span>
                                </div>
                                @if (($pendingWorkflowCount ?? 0) > 0)
                                    <span
                                        class="inline-flex items-center justify-center h-5 px-1.5 min-w-5 text-[10px] font-bold leading-none {{ request()->routeIs('admin.workflow.index') ? 'bg-white text-(--primary-color)' : 'bg-rose-500 text-white' }} rounded-full">
                        ...
                        {{ request()->routeIs('admin.workflow.index')
                            ...
                            : 'text-gray-600 hover:bg-(--primary-color)/5 hover:text-(--primary-color)' }}">
                                <i
                                    class="text-lg bi bi-clock-history {{ request()->routeIs('admin.workflow.index') ? 'text-white' : 'text-gray-400 group-hover:text-(--primary-color)' }}"></i>
                        ...
                        {{ request()->routeIs('admin.workflow.history')
                            ...
                            : 'text-gray-600 hover:bg-(--primary-color)/5 hover:text-(--primary-color)' }}">
                            <i
                                class="text-lg bi bi-journal-text {{ request()->routeIs('admin.workflow.history') ? 'text-white' : 'text-gray-400 group-hover:text-(--primary-color)' }}"></i>
        ...
        @can('institution.view')
            <div>
                ...
                {{ request()->routeIs('admin.institutions*')
                    ...
                    : 'text-gray-600 hover:bg-(--primary-color)/5 hover:text-(--primary-color)' }}">
                    <i
                        class="text-lg bi bi-bank2 {{ request()->routeIs('admin.institutions*') ? 'text-white' : 'text-gray-400 group-hover:text-(--primary-color)' }}"></i>
            ...
            <div class="space-y-1">
                    ...
                    <div x-data="{ homeMenuOpen: {{ $isHomeActive ? 'true' : 'false' }} }">
                        <button @click="homeMenuOpen = !homeMenuOpen"
                            ...
                            <span class="flex items-center gap-3">
                                <i
                                    class="text-lg bi bi-house-gear-fill {{ $isHomeActive ? 'text-(--primary-color)' : 'text-gray-400 group-hover:text-(--primary-color)' }}"></i>
                                Homepage Setup
                            </span>
                            <i class="bi bi-chevron-right text-xs transition-transform duration-300"
                                :class="homeMenuOpen ? 'rotate-90' : ''"></i>
                        </button>

                        <div x-show="homeMenuOpen" x-collapse
                            ...
                            @php
                                $homeLinks = [
                                    ...
                                    [
                                        'route' => 'admin.instagram-feeds.index',
                ...
                @can('popup.manage')
                    ...
                    {{ request()->routeIs('admin.popups*')
                        ...
                        : 'text-gray-600 hover:bg-(--primary-color)/5 hover:text-(--primary-color)' }}">
                        <i
                            class="text-lg bi bi-window-stack {{ request()->routeIs('admin.popups*') ? 'text-white' : 'text-gray-400 group-hover:text-(--primary-color)' }}"></i>
                        Admissions Popups
                    </a>
                @endcan
                ...
                @can('view pages')
                    ...
                    {{ request()->routeIs('admin.pagebuilder*')
                        ...
                        : 'text-gray-600 hover:bg-(--primary-color)/5 hover:text-(--primary-color)' }}">
                        <i
                            class="text-lg bi bi-magic {{ request()->routeIs('admin.pagebuilder*') ? 'text-white' : 'text-gray-400 group-hover:text-(--primary-color)' }}"></i>
                        Page Designer
                    </a>
                @endcan
                ...
                @can('manage menus')
                    ...
                    {{ request()->routeIs('admin.menus*')
                        ...
                        : 'text-gray-600 hover:bg-(--primary-color)/5 hover:text-(--primary-color)' }}">
                        <i
                            class="text-lg bi bi-list-nested {{ request()->routeIs('admin.menus*') ? 'text-white' : 'text-gray-400 group-hover:text-(--primary-color)' }}"></i>
                        Navigation Menu
                    </a>
                @endcan
            ...
            <div>
                ...
                <div x-data="{ leadsMenuOpen: {{ $isLeadsActive ? 'true' : 'false' }} }" class="space-y-1">
                    <button @click="leadsMenuOpen = !leadsMenuOpen"
                        ...
                        <span class="flex items-center gap-3">
                            <i
                                class="text-lg bi bi-person-badge-fill {{ $isLeadsActive ? 'text-(--primary-color)' : 'text-gray-400 group-hover:text-(--primary-color)' }}"></i>
                            Lead Hub
                        </span>
                        <i class="bi bi-chevron-right text-xs transition-transform duration-300"
                            :class="leadsMenuOpen ? 'rotate-90' : ''"></i>
                    </button>

                    <div x-show="leadsMenuOpen" x-collapse
                        class="mt-1 ml-4 pl-4 border-l-2 border-(--primary-color)/20 space-y-1">
            ...
            <div>
                ...
                <div class="space-y-1">
                    ...
                    {{ request()->routeIs('admin.users*')
                        ...
                        : 'text-gray-600 hover:bg-(--primary-color)/5 hover:text-(--primary-color)' }}">
                            <i
                                class="text-lg bi bi-shield-shaded {{ request()->routeIs('admin.users*') ? 'text-white' : 'text-gray-400 group-hover:text-(--primary-color)' }}"></i>
                            Staff Accounts
                        </a>
                    @endcan
                    ...
                    {{ request()->routeIs('admin.roles-permissions*')
                        ...
                        : 'text-gray-600 hover:bg-(--primary-color)/5 hover:text-(--primary-color)' }}">
                            <i
                                class="text-lg bi bi-key-fill {{ request()->routeIs('admin.roles-permissions*') ? 'text-white' : 'text-gray-400 group-hover:text-(--primary-color)' }}"></i>
                            Access Rights
                        </a>
                    @endcan
                    ...
                    {{ request()->routeIs('admin.website-settings*')
                        ...
                        : 'text-gray-600 hover:bg-(--primary-color)/5 hover:text-(--primary-color)' }}">
                        <i
                            class="text-lg bi bi-sliders {{ request()->routeIs('admin.website-settings*') ? 'text-white' : 'text-gray-400 group-hover:text-(--primary-color)' }}"></i>
                        Global Settings
                    </a>
                    ...
                    {{ request()->routeIs('admin.smtp*')
                        ...
                        : 'text-gray-600 hover:bg-(--primary-color)/5 hover:text-(--primary-color)' }}">
                        <i
                            class="text-lg bi bi-envelope-at-fill {{ request()->routeIs('admin.smtp*') ? 'text-white' : 'text-gray-400 group-hover:text-(--primary-color)' }}"></i>
                        SMTP Settings
                    </a>
                </div>
            </div>
        ...
        <div class="flex items-center gap-3">
            <div class="relative">
                @if (auth()->user()->avatar)
                    <img src="{{ auth()->user()->avatar }}"
                        class="object-cover w-10 h-10 rounded-xl shadow-sm border-2 border-white">
                @else
                    <div
                        class="flex items-center justify-center w-10 h-10 text-xs font-black text-white bg-linear-to-br from-(--primary-color) to-(--primary-hover) rounded-xl shadow-sm">
                        {{ auth()->user()->initials }}
                    </div>
                @endif
            ...
            <div class="flex-1 overflow-hidden">
                ...
                <div class="text-[10px] text-gray-400 font-bold uppercase truncate">
                    {{ auth()->user()->getRoleNames()->first() ?? 'Staff Member' }}</div>
            </div>
            <a href="{{ route('logout') }}"
